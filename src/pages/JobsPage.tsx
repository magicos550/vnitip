  ...
  return (
    <>
      ...
      <View style={styles.menu}>
        ...
        <TouchableOpacity
          style={[styles.menuButton, { backgroundColor: theme.colors.menuPurple }]}
          onPress={() => navigation.navigate('LiveWeight')}
        >
        ...
        <TouchableOpacity
          style={[styles.menuButton, { backgroundColor: theme.colors.menuGreen }]}
